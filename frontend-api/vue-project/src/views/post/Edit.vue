...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            ////get API dari Laravel Backend menggunakan axios setelah itu promise memasukan state posts dengan response data dari api
            axios.get(`http://localhost:8000/api/post/${route.params.id}`)
            .then(response => {
              
              //memasukan variabel state posts reactive dengan response data dari api
        ...
        function update() {
            ...
            // Menggunakan axios dan method PUT untuk Update setelah itu diredirect ke index
